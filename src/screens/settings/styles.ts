...
export const createSettingsStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  systemPromptCardTitle: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8 },
  systemPromptIndex: {
    minWidth: 24,
    height: 24,
    borderRadius: 12,
  ...
  systemPromptName: { flex: 1, fontSize: 15, fontWeight: '600', color: colors.text },
  systemPromptOrderButtons: { flexDirection: 'row', gap: 2, marginRight: 6 },
  systemPromptOrderButton: {
    width: 30,
    height: 30,
    alignItems: 'center',
  ...
  systemPromptOrderButtonDisabled: { opacity: 0.3 },
  systemPromptOrderText: { color: colors.textSecondary, fontSize: 17, fontWeight: '600' },
  systemPromptDeleteButton: { alignSelf: 'flex-end', paddingHorizontal: 8, paddingVertical: 8 },
  systemPromptDeleteText: { color: colors.danger, fontSize: 13, fontWeight: '500' },
  toolCardEnabled: {
